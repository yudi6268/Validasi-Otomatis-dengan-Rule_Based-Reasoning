    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.dashboard') && request()->query('section', 'dashboard') === 'dashboard' ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.users.index') || request()->routeIs('admin.users.edit') || request()->routeIs('admin.users.create') ? 'active' : ''); ?>">
                        <i class="fas fa-users"></i> Kelola Pengguna
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.users.pending')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.users.pending') ? 'active' : ''); ?>">
