    ...
    ">
        ...
        <div style="margin-bottom: 12px;">
            ...
            <textarea
                ...
                style="
                    ...
                    background: #e9ecef;
                "
            ><?php echo e(old('tugas_pelaksana', $perjanjian->tugas_pelaksana ?? ($jabatanData ? $jabatanData->tugas : ''))); ?></textarea>
        </div>
        ...
        <div>
            ...
            ">
                ...
                <?php if($fungsiValue): ?>
                    <?php if(is_array($fungsiValue)): ?>
                        <ol style="margin: 0; padding-left: 20px;">
                            <?php $__currentLoopData = $fungsiValue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fungsi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li style="margin-bottom: 4px;"><?php echo e($fungsi); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ol>
                    <?php else: ?>
                        <?php echo e($fungsiValue); ?>
