...
<body>
    <div class="page-shell">
        <aside class="sidebar">
            <div class="brand">
                <img src="<?php echo e(asset('images/logo_rsud.png')); ?>" alt="RSUD Bangil">
                <div>
            ...
            <div class="profile-card">
                <div class="avatar"><?php echo e(strtoupper(substr(auth()->user()->nama, 0, 1))); ?></div>
                <div class="info">
                    <div class="name"><?php echo e(auth()->user()->nama); ?></div>
                    <div class="role"><?php echo e(auth()->user()->jabatan ?? 'Pengguna'); ?></div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="menu-list">
                    <a href="<?php echo e($dashboardBackRoute); ?>" class="menu-item <?php echo e(($activeSection ?? 'dashboard') === 'dashboard' ? 'active' : ''); ?>">
                        <i class="fas fa-chart-pie"></i>
                        Dashboard
                    </a>
                    <a href="<?php echo e(route('home', ['section' => 'perjanjian'])); ?>" target="_self" class="menu-item <?php echo e(($activeSection ?? '') === 'perjanjian' ? 'active' : ''); ?>">
                        <i class="fas fa-file-contract"></i>
                        Perjanjian Kinerja
                    </a>
                    <a href="<?php echo e(route('home', ['section' => 'laporan'])); ?>" class="menu-item <?php echo e(($activeSection ?? '') === 'laporan' ? 'active' : ''); ?>">
                        <i class="fas fa-chart-line"></i>
                        Laporan Kinerja
                    </a>
                    <a href="<?php echo e(route('home', ['section' => 'profil'])); ?>" class="menu-item <?php echo e(($activeSection ?? '') === 'profil' ? 'active' : ''); ?>">
        ...
        <section class="main-area">
            <div class="topbar">
                <div class="greeting">
                    <span>Halo, <?php echo e(auth()->user()->nama); ?></span>
                    <h1>Dashboard Perjanjian & Laporan Kinerja</h1>
                </div>
                <div class="actions">
                    <a href="<?php echo e(route('home', ['section' => 'perjanjian'])); ?>" target="_self" class="button"><i class="fas fa-file-contract"></i> Perjanjian</a>
                    <a href="<?php echo e(route('home', ['section' => 'laporan'])); ?>" class="button"><i class="fas fa-chart-line"></i> Laporan</a>
                </div>
            </div>
                ...
                <div class="dashboard-main-grid">
                    <div class="section-card chart-surface">
                        <div class="section-header" style="margin-bottom: 6px;">
                            ...
                            <a href="<?php echo e(route('home', ['section' => 'laporan'])); ?>">Buka Laporan</a>
                        </div>
                        <div class="chart-meta">
                            ...
                            <span class="badge approved" style="font-size:11px;"><?php echo e(!empty($userChartData['hasData']) ? 'Data tersedia' : 'Belum ada realisasi'); ?></span>
                        </div>
                    ...
                    <div class="content-block">
                        <div class="section-card">
                            <div class="section-header">
                                ...
                                <a href="<?php echo e(route('home', ['section' => 'perjanjian'])); ?>" target="_self">Lihat Semua</a>
                            </div>
                                ...
                                <table>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $perjanjians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perjanjian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(Str::limit($perjanjian->judul ?? 'Perjanjian Kinerja', 30)); ?></td>
                                            <td>
                                                <?php if(empty($perjanjian->pihak2_signature) && (empty($perjanjian->rejected) || !$perjanjian->rejected)): ?>
                                                    <span class="badge waiting">Menunggu</span>
                                                <?php elseif(!empty($perjanjian->pihak2_signature) && (empty($perjanjian->rejected) || !$perjanjian->rejected)): ?>
                                            ...
                                            <td><a class="action-link" href="<?php echo e(route('perjanjian.edit', $perjanjian->id)); ?>"><i class="fas fa-pen"></i> Edit</a></td>
                                        </tr>
                        ...
                        <div class="section-card">
                            <div class="section-header">
                                <h2>Menu Cepat</h2>
                                <a href="<?php echo e(route('home', ['section' => 'profil'])); ?>">Profil Saya</a>
                            </div>
                            <div style="display: grid; gap: 16px;">
                                <a href="<?php echo e(route('home', ['section' => 'perjanjian'])); ?>" target="_self" class="action-link"><i class="fas fa-file-contract"></i> Buka Perjanjian Kinerja</a>
                                <a href="<?php echo e(route('home', ['section' => 'laporan'])); ?>" class="action-link"><i class="fas fa-chart-line"></i> Buka Laporan Kinerja</a>
                                <a href="<?php echo e(route('home', ['section' => 'profil'])); ?>" class="action-link"><i class="fas fa-user"></i> Lihat Profil Internal</a>
                            </div>
                        </div>
                    </div>
                </div>
            <?php elseif($activeSection === 'perjanjian'): ?>
                                ...
                                <?php else: ?>
                                    <?php $__currentLoopData = $perjanjians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perjanjian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="card-panel" style="padding:18px; border-radius:20px; box-shadow: none; background: #f8fffb;">
                                            <div style="font-weight:700;color:#16333a; margin-bottom: 8px;"><?php echo e(Str::limit($perjanjian->judul ?? 'Perjanjian Kinerja', 45)); ?></div>
                                            <div style="font-size:13px;color:#5f7b74; margin-bottom: 10px;"><?php echo e($perjanjian->created_at?->format('d M Y') ?? '-'); ?></div>
                                            <div>
                                                <?php if(empty($perjanjian->pihak2_signature) && (empty($perjanjian->rejected) || !$perjanjian->rejected)): ?>
                                                    <span class="badge waiting">Menunggu</span>
                                                <?php elseif(!empty($perjanjian->pihak2_signature) && (empty($perjanjian->rejected) || !$perjanjian->rejected)): ?>
                    ...
                    <div class="panel-side">
                        <div class="section-card">
                            <div class="section-header">
                                ...
                                <a href="<?php echo e(route('perjanjian.index')); ?>">Lihat Semua</a>
                            </div>
                            <div class="panel-list">
                                <a href="<?php echo e(route('perjanjian.create')); ?>" target="_self" class="action-link"><i class="fas fa-plus"></i> Buat Perjanjian Baru</a>
                                <a href="<?php echo e(route('perjanjian.index')); ?>" class="action-link"><i class="fas fa-list"></i> Daftar Perjanjian Kinerja</a>
                                <a href="<?php echo e($dashboardBackRoute); ?>" class="action-link"><i class="fas fa-home"></i> Kembali ke Dashboard</a>
                            </div>
                        </div>
                        <div class="section-card">
                            <div class="section-header">
            ...
            <?php elseif($activeSection === 'laporan'): ?>
                ...
                <div class="section-layout">
                    <div>
                        <div class="stats-grid">
                            <div class="card-panel" style="text-align:center;">
                                ...
                                <div class="value"><?php echo e($laporanTotal ?? 0); ?></div>
                                <div class="help">Jumlah laporan yang sudah dibuat.</div>
                            </div>
                            <div class="card-panel" style="text-align:center;">
                                <div class="title">Disetujui</div>
                                <div class="value"><?php echo e($laporanValidated ?? 0); ?></div>
                                <div class="help">Laporan sudah selesai dan disetujui.</div>
                            </div>
                            <div class="card-panel" style="text-align:center;">
                                <div class="title">Menunggu</div>
                                <div class="value"><?php echo e($laporanWaiting ?? 0); ?></div>
                                <div class="help">Laporan yang masih dalam proses.</div>
                            </div>
                            <div class="card-panel" style="text-align:center;">
                                <div class="title">Ditolak</div>
                                <div class="value"><?php echo e($laporanRejected ?? 0); ?></div>
                        ...
                        <div class="section-card">
                            ...
                            <div style="display:grid; gap:14px;">
                                <?php if($laporansLatest->isEmpty()): ?>
                                    <div class="empty-row">Belum ada laporan kinerja. Setelah perjanjian disetujui, Anda dapat membuat laporan.</div>
                                <?php else: ?>
                                    <?php $__currentLoopData = $laporansLatest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="card-panel" style="padding:18px; border-radius:20px; box-shadow: none; background: #f8fffb;">
                                            <div style="font-weight:700;color:#16333a; margin-bottom: 8px;"><?php echo e(Str::limit(optional($laporan->perjanjian)->judul ?? 'Perjanjian Kinerja', 45)); ?></div>
                                            <div style="font-size:13px;color:#5f7b74; margin-bottom: 10px;">Triwulan: <?php echo e($laporan->periode ?? '-'); ?></div>
                                            <div>
                                                <?php if(!empty($laporan->kesimpulan)): ?>
                                                    <span class="badge approved">Disetujui</span>
                                                <?php elseif(!empty($laporan->tanggapan_pimpinan)): ?>
                    ...
                    <div class="panel-side">
                        <div class="section-card">
                            <div class="section-header">
                                <h2>Menu Laporan</h2>
                                <a href="<?php echo e(route('laporan.kinerja')); ?>">Lihat Semua</a>
                            </div>
                            <div class="panel-list">
                                <a href="<?php echo e(route('laporan.kinerja')); ?>" class="action-link"><i class="fas fa-eye"></i> Buka Laporan Kinerja</a>
                                <a href="<?php echo e($dashboardBackRoute); ?>" class="action-link"><i class="fas fa-home"></i> Kembali ke Dashboard</a>
                            </div>
                        </div>
                        <div class="section-card">
            ...
            <?php elseif($activeSection === 'profil'): ?>
    ...
    <div id="notificationModal" class="modal-overlay" style="display: <?php echo e(!empty($shouldShowHomeNotification) && !empty($homeNotification) ? 'grid' : 'none'); ?>;">
        <div class="modal-box">
            <h3><?php echo e($homeNotification->title ?? 'Notifikasi Baru'); ?></h3>
            <p><?php echo e($homeNotification->message ?? 'Anda memiliki notifikasi baru dari admin.'); ?></p>
    ...
    <script>
        const userChartPayload = <?php echo json_encode($userChartData ?? ['labels' => ['Triwulan 1', 'Triwulan 2', 'Triwulan 3') ?>;
        ...
        const notificationId = <?php echo json_encode($homeNotification->id ?? null, 15, 512) ?>;
        const notificationReadUrl = notificationId ? '<?php echo e(route('notifications.markAsRead', ['id' => '__ID__'])); ?>'.replace('__ID__', notificationId) : null;
...
<?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\home.blade.php ENDPATH**/ ?>