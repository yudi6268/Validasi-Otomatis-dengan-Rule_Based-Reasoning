...
<body>
            ...
            <?php else: ?>
                ...
                <div class="stats-grid">
                    <div class="stat-card green active" data-filter="all">
                        ...
                        <div class="number"><?php echo e($counts['all'] ?? 0); ?></div>
                    </div>
                    <div class="stat-card yellow" data-filter="setuju">
                        <div class="label">Disetujui</div>
                        <div class="number"><?php echo e($counts['approved'] ?? 0); ?></div>
                    </div>
                    <div class="stat-card blue" data-filter="menunggu">
                        <div class="label">Menunggu Approval</div>
                        <div class="number"><?php echo e($counts['waiting'] ?? 0); ?></div>
                    </div>
                    <div class="stat-card red" data-filter="tolak">
                        <div class="label">Ditolak</div>
                        <div class="number"><?php echo e($counts['rejected'] ?? 0); ?></div>
                    </div>
                </div>
                ...
                <div class="section">
                    <div class="section-title">
                        ...
                        <a href="<?php echo e(route('direktur.perjanjian.list')); ?>">Lihat Semua</a>
                    </div>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody id="dataTable">
                            <?php $__empty_1 = true; $__currentLoopData = $perjanjians ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $perjanjian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e(($perjanjians->currentPage() - 1) * $perjanjians->perPage() + $loop->iteration); ?></td>
                                    <td><?php echo e($perjanjian->jenis ?? ($perjanjian->jenis_perjanjian ?? 'Perjanjian Kinerja')); ?></td>
                                    <td><?php echo e($perjanjian->pihak1_jabatan ?? '-'); ?></td>
                                    <td><?php echo e($perjanjian->periode ?? $perjanjian->created_at?->format('Y') ?? '-'); ?></td>
                                    <td><?php echo e($perjanjian->pihak1_name ?? '-'); ?></td>
                                    <td>
                                        <button type="button" class="btn-action" onclick="showPreview(<?php echo e($perjanjian->id); ?>)">Review</button>
                                        <button type="button" class="btn-action reject" onclick="showRejectModal(<?php echo e($perjanjian->id); ?>)">Tolak</button>
                                        <a href="<?php echo e(route('direktur.perjanjian.print', $perjanjian->id)); ?>" target="_blank">
    ...
    <script>
        ...
        const reviewBaseUrl = '<?php echo e(url('/dashboard/direktur/perjanjian')); ?>';
        ...
        (function() {
            ...
            if (!ctx) return;
            const labels = <?php echo json_encode($monthly['labels'] ?? []); ?>;
            const approved = <?php echo json_encode($monthly['approved'] ?? []); ?>;
            const rejected = <?php echo json_encode($monthly['rejected'] ?? []); ?>;
