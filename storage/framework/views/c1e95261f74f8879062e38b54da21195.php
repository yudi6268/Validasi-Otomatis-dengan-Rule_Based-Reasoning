        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.kegiatan.update', $kegiatan['id'])); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_kegiatan" id="kode_kegiatan" class="form-control <?php $__errorArgs = ['kode_kegiatan'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Contoh: KGT001" required value="<?php echo e(old('kode_kegiatan', $kegiatan['kode_kegiatan'])); ?>">
