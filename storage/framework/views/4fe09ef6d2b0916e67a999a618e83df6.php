...
<?php $__env->startSection('page-title', 'Tambah Pengguna Baru'); ?>

<?php $__env->startSection('content'); ?>
<div class="row">
    <div class="col-md-8">
        <div class="data-table">
            <form id="userCreateForm" action="<?php echo e(route('admin.users.store')); ?>" method="POST" autocomplete="off">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('id_pegawai')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <option value="non-active" <?php echo e(old('status') == 'non-active' ? 'selected' : ''); ?>>Non Aktif</option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nip')); ?>" required>
                        <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $jabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($jab->nama_jabatan); ?>" <?php echo e(old('jabatan') == $jab->nama_jabatan ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('pangkat')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('divisi')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <option value="direktur" <?php echo e(old('role') == 'direktur' ? 'selected' : ''); ?>>Direktur</option>
                        <option value="wadir" <?php echo e(old('role') == 'wadir' ? 'selected' : ''); ?>>Wakil Direktur</option>
                    </select>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views/admin/users/create.blade.php ENDPATH**/ ?>