...
<body>
  ...
  <main>
    <div class="profile-card">
      <form method="POST" action="<?php echo e(route('profil.update')); ?>" enctype="multipart/form-data" class="profile-form" id="profileForm">
        <?php echo csrf_field(); ?>
        <label for="nama">Nama Pegawai</label>
        <div class="input-wrap"><input type="text" id="nama" name="nama" value="<?php echo e($user->nama); ?>" readonly></div>
        <label for="id_pegawai">ID Pegawai</label>
        <div class="input-wrap"><input type="text" id="id_pegawai" name="id_pegawai" value="<?php echo e($user->id_pegawai); ?>" readonly></div>
        <label for="nip">NIP</label>
        <div class="input-wrap"><input type="text" id="nip" name="nip" value="<?php echo e($user->nip); ?>" readonly></div>
        <label for="emailInput">Email</label><div class="input-wrap"><input type="email" id="emailInput" name="email" value="<?php echo e(auth()->user()->email); ?>" readonly disabled></div>
        <label for="jabatan">Jabatan</label>
        <div class="input-wrap"><input type="text" id="jabatan" name="jabatan" value="<?php echo e($user->jabatan); ?>" readonly></div>
        <label for="pangkat">Pangkat</label>
        <div class="input-wrap"><input type="text" id="pangkat" name="pangkat" value="<?php echo e($user->pangkat); ?>" readonly></div>
      ...
      <div class="profile-side">
        <div class="photo" id="photoPreview" style="margin-bottom:16px;">
          <?php if($user->foto_profil && str_starts_with($user->foto_profil, 'http')): ?>
              <img src="<?php echo e($user->foto_profil); ?>?v=<?php echo e(time()); ?>" alt="Foto Profil">
          <?php elseif($user->foto_profil): ?>
              <img src="<?php echo e(asset('storage/'.$user->foto_profil)); ?>?v=<?php echo e(time()); ?>" alt="Foto Profil">
          <?php else: ?>
              FOTO PROFIL
          <?php endif; ?>
        </div>
        ...
        <div id="fotoModal" class="modal" style="display:none;position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(0,0,0,0.4);justify-content:center;align-items:center;z-index:999;">
          <form method="POST" action="<?php echo e(route('profil.upload_foto')); ?>" enctype="multipart/form-data" style="background:#fff;padding:30px;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.1);text-align:center;position:relative;min-width:350px;">
        ...
        <div class="signature-box" id="signatureBox" style="cursor:pointer;margin-bottom:12px;">
          <?php if($user->tanda_tangan && str_starts_with($user->tanda_tangan, 'http')): ?>
            <img src="<?php echo e($user->tanda_tangan); ?>?v=<?php echo e(time()); ?>" alt="Tanda Tangan">
          <?php elseif($user->tanda_tangan): ?>
            <img src="<?php echo e(asset('storage/'.$user->tanda_tangan)); ?>?v=<?php echo e(time()); ?>" alt="Tanda Tangan">
          <?php else: ?>
        ...
        <div id="ttdModal" class="modal" style="display:none;position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(0,0,0,0.4);justify-content:center;align-items:center;z-index:999;">
          <form method="POST" action="<?php echo e(route('profil.upload_ttd')); ?>" enctype="multipart/form-data" style="background:#fff;padding:30px;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.1);text-align:center;position:relative;min-width:350px;">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\profil.blade.php ENDPATH**/ ?>