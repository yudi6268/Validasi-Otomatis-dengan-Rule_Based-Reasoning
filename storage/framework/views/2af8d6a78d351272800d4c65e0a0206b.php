        ...
        <div class="modal-content">
            <div class="modal-header" style="background: #1E88E5; color: white;">
                <h5 class="modal-title" id="perjanjianModalLabel">
                    <i class="fas fa-file-contract"></i> Daftar Perjanjian Kinerja (<?php echo e(count($allPerjanjianModal)); ?>)
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="d-flex justify-content-end mb-2">
                    <a href="<?php echo e(route('admin.perjanjian.index')); ?>" class="btn btn-sm btn-outline-primary">
                        <i class="fas fa-cog"></i> Kelola Perjanjian
                    </a>
                </div>
                <?php if(!empty($allPerjanjianModal)): ?>
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $allPerjanjianModal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td><strong><?php echo e($pj['nama']); ?></strong></td>
                                        <td><small><?php echo e($pj['jabatan']); ?></small></td>
                                        <td><?php echo e($pj['tahun']); ?></td>
                                        <td><small><?php echo e($pj['tanggal']); ?></small></td>
                                        <td><span class="badge <?php echo e($pj['badgeClass']); ?>"><?php echo e($pj['statusText']); ?></span></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
        ...
        <div class="modal-content">
            <div class="modal-header" style="background: #00B5A0; color: white;">
                <h5 class="modal-title" id="usersModalLabel">
                    <i class="fas fa-users"></i> Daftar Pengguna (<?php echo e($totalUsers); ?>)
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <?php if($allUsers->isNotEmpty()): ?>
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        ...
                                        <td><?php echo e(ucfirst($user->status ?? 'aktif')); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
        ...
        <div class="modal-content">
            <div class="modal-header" style="background: #FF9800; color: white;">
                <h5 class="modal-title" id="jabatanModalLabel">
                    <i class="fas fa-briefcase"></i> Daftar Jabatan (<?php echo e($jabatanStats->count()); ?>)
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <?php if($jabatanStats->isNotEmpty()): ?>
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $jabatanStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jabatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><strong><?php echo e($jabatan->nama_jabatan); ?></strong></td>
                                        <td><?php echo e(Str::limit($jabatan->tugas ?? '-', 50)); ?></td>
                                        <td><span class="badge bg-primary"><?php echo e($jabatan->users_count ?? 0); ?></span></td>
                                        <td>
