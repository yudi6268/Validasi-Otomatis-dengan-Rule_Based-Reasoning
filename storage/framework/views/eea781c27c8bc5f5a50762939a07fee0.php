...
<body style="min-height:100vh;">
    ...
    <div class="preview-center-wrapper">
        ...
        <div class="preview-card">
            ...
            <?php if(!isset($pdf_part) || $pdf_part == 'portrait'): ?>
            ...
            <?php if($hasTabelAData || $hasProgramData): ?>
                ...
                <div class="page">
                    <div class="header" style="text-align:center;">
                        ...
                        <div style="font-weight:bold;font-size:9pt;margin-bottom:1px;line-height:1.1;">TAHUN <?php echo e($tahun ?? '2025'); ?></div>
                    </div>
            ...
            <?php if((!isset($pdf_part) || $pdf_part == 'landscape') && ($hasTabelBData || $hasTabelDData)): ?>
                <!-- PAGE 3: RENCANA AKSI -->
                        ...
                        <?php endif; ?>
                            ...
                            <div class="signature-wrapper" style="margin-top: 20px; width: 100%; text-align: left;">
                                <div class="signature-block" style="width: auto; display: inline-block; text-align: center; margin-left: 15%;">
                                    ...
                                    <?php if(!empty($for_pdf) && !empty($pihak1_ttd_data)): ?>
                                        <img src="<?php echo e($pihak1_ttd_data); ?>" style="max-height:40px;margin:5px 0;" alt="TTD Pihak 1">
                                    <?php elseif(!empty($perjanjian->pihak1_ttd)): ?>
                                        <img src="<?php echo e($perjanjian->pihak1_ttd); ?>" style="max-height:40px;margin:5px 0;" alt="TTD Pihak 1" loading="lazy">
                                    <?php else: ?>
...
</html><?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\perjanjian\pdf-snappy.blade.php ENDPATH**/ ?>