...
<body>
  ...
  <!-- HEADER -->
  <header>
    <a href="<?php echo e(route('home')); ?>"><i class="fa-solid fa-arrow-left back-icon"></i></a>
    <h1>Settings</h1>
  ...
  <main>
    ...
    <?php if($errors->any()): ?>
      <div class="alert alert-danger" id="alertError" role="alert">
        ...
        <span>
          ...
          <?php elseif($errors->has('new_password')): ?>
            <?php echo e($errors->first('new_password')); ?>

          <?php elseif($errors->has('current_email')): ?>
            <?php echo e($errors->first('current_email')); ?>

          <?php elseif($errors->has('new_email')): ?>
            <?php echo e($errors->first('new_email')); ?>
    ...
    <div class="form-section">
      ...
      <!-- GANTI PASSWORD -->
      <form class="form-group" id="passwordForm" method="POST" action="<?php echo e(route('settings.password.update')); ?>">
        <?php echo csrf_field(); ?>

        <!-- USER IDENTIFIER (HIDDEN - UNTUK ACCESSIBILITY) -->
        <input
          type="email" name="email" value="<?php echo e(auth()->user()->email); ?>" autocomplete="username" hidden>
      ...
      <!-- GANTI EMAIL -->
      <form id="emailForm" class="form-group" method="POST" action="<?php echo e(route('settings.email.update')); ?>">
        <?php echo csrf_field(); ?>

        <h2><i class="fa-solid fa-envelope"></i> Ganti Email</h2>

        <div class="input-row">
          <input type="email" name="current_email" id="current_email" placeholder="Email Lama" value="<?php echo e(auth()->user()->email); ?>" readonly required>
  ...
  <script>
    ...
    window.addEventListener('focus', async () => {
      try {
        const response = await fetch('<?php echo e(route('home')); ?>', {
          method: 'HEAD',
...
</html><?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\settings.blade.php ENDPATH**/ ?>