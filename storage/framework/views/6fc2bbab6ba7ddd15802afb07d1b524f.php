...
<head>
    ...
    <title>Dashboard Staff - RSUD Bangil</title>
...
<body>
    ...
    <header>
        <div class="logo-container">
            ...
            <span class="header-title">Dashboard Staff</span>
        </div>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-menu">
                <a href="<?php echo e(route('perjanjian.index')); ?>" target="_self" class="active">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                ...
                <p>Kelola perjanjian dan laporan kinerja Anda dengan mudah</p>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card green">
                    ...
                    <div class="number"><?php echo e($perjanjianApproved ?? 0); ?></div>
                    <div class="sublabel">Perjanjian</div>
                </div>
                <div class="stat-card yellow">
                    <div class="label">Menunggu Approval</div>
                    <div class="number"><?php echo e($perjanjianWaiting ?? 0); ?></div>
                    <div class="sublabel">Perjanjian</div>
                </div>
                <div class="stat-card red">
                    <div class="label">Ditolak</div>
                    <div class="number"><?php echo e($perjanjianRejected ?? 0); ?></div>
                    <div class="sublabel">Perjanjian</div>
                </div>
            </div>
            ...
            <div class="section">
                <div class="section-title">
                    ...
                    <a href="<?php echo e(route('perjanjian.index')); ?>" target="_self">Lihat Semua</a>
                </div>
                <table>
                    <thead>
                        <tr>
...
<?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\dashboard\katimker-staf.blade.php ENDPATH**/ ?>