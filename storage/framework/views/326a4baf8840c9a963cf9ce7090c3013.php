            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if(!empty($membawahi) && is_array($membawahi)): ?>
                        <ul class="mb-0">
                            <?php $__currentLoopData = $membawahi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php echo e($unit); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    <?php else: ?>
                        -
                ...
                <td>
                    ...
                    <form action="<?php echo e(route('admin.jabatan.destroy', $item['id'])); ?>"
                        ...
                        <button type="button" class="btn btn-danger btn-sm"
                                onclick="showDeleteConfirmModal(this.closest('form'), 'Apakah Anda yakin ingin menghapus jabatan <?php echo e($item['nama_jabatan']); ?>?')">
                            Hapus
                        </button>
                    </form>
                </td>
...
<?php endif; ?>
<?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views/admin/jabatan/partials/table.blade.php ENDPATH**/ ?>