...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <h2>Halo, <?php echo e($user->nama); ?>!</h2>
            ...
            <div class="info-box">
                ...
                <strong>Nama:</strong> <?php echo e($user->nama); ?><br>
                <strong>NIP:</strong> <?php echo e($user->nip); ?><br>
                <strong>Email:</strong> <?php echo e($user->email); ?><br>
                <strong>Jabatan:</strong> <?php echo e($user->jabatan); ?><br>
                <strong>Role:</strong> <?php echo e(ucfirst($user->role)); ?>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/login')); ?>" class="btn">Login Sekarang</a>
            </div>
...
<?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\emails\welcome-user.blade.php ENDPATH**/ ?>