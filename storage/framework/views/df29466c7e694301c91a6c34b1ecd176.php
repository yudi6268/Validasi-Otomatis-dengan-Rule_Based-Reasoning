  ...
  <div class="triwulan-card">
    ...
    <form id="triwulanForm">
      ...
      <div class="radio-group">
        <label class="radio-item <?php echo e($triwulan === 1 ? 'active' : ''); ?>">
          <input type="radio" name="triwulan" value="1" <?php echo e($triwulan === 1 ? 'checked' : ''); ?>>
        ...
        <label class="radio-item <?php echo e($triwulan === 2 ? 'active' : ''); ?>">
          <input type="radio" name="triwulan" value="2" <?php echo e($triwulan === 2 ? 'checked' : ''); ?>>
          <div class="radio-label">
        ...
        <label class="radio-item <?php echo e($triwulan === 3 ? 'active' : ''); ?>">
          <input type="radio" name="triwulan" value="3" <?php echo e($triwulan === 3 ? 'checked' : ''); ?>>
          <div class="radio-label">
        ...
        <label class="radio-item <?php echo e($triwulan === 4 ? 'active' : ''); ?>">
          <input type="radio" name="triwulan" value="4" <?php echo e($triwulan === 4 ? 'checked' : ''); ?>>
          <div class="radio-label">
...
<script>
  ...
  document.getElementById('triwulanForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("admin.triwulan.setting.update")); ?>', {
      method: 'POST',
      headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\admin\triwulan-setting.blade.php ENDPATH**/ ?>