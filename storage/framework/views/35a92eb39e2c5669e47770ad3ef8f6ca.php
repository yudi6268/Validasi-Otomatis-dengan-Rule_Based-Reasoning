    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <p style="font-size: 24px; text-align: center; margin: 0;">
                Kode Verifikasi Anda: <strong><?php echo e($code); ?></strong>
            </p>
        </div>
...
</html><?php /**PATH E:\Kuliah\Semester 7\Magang\Perjanjian Kinerja\resources\views\emails\forgot-password.blade.php ENDPATH**/ ?>