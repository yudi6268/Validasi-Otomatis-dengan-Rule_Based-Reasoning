        ...
        <div class="data-table">
            ...
            <form id="jabatanForm" method="POST" action="<?php echo e(route('admin.jabatan.update', $jabatan['id'])); ?>" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_jabatan" class="form-control" placeholder="Contoh: Direktur" value="<?php echo e(old('nama_jabatan', $jabatan['nama_jabatan'])); ?>" required <?php if(session('success')): ?> disabled <?php endif; ?>>
                </div>
                <div class="mb-3">
                    <label class="form-label">Tugas</label>
                    <textarea name="tugas" class="form-control" placeholder="Deskripsi tugas jabatan ini..." rows="3" <?php if(session('success')): ?> disabled <?php endif; ?>><?php echo e(old('tugas', $jabatan['tugas'])); ?></textarea>
                </div>
                ...
                <div class="form-check mb-2">
                    <input class="form-check-input" type="checkbox" name="is_active" value="1" id="isActive" <?php echo e(old('is_active', $jabatan['is_active']) ? 'checked' : ''); ?> <?php if(session('success')): ?> disabled <?php endif; ?>>
