...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            @if($status === 'rejected' && $perjanjian->rejection_reason)
    ...
    <div class="content">
        ...
        <div class="info-card">
            <div class="info-row">
                ...
                <div class="info-value">{{ $perjanjian->pihak1_name }} ({{ $perjanjian->pihak1_jabatan }})</div>
            </div>
            <div class="info-row">
                <div class="info-label">Pihak Kedua:</div>
                <div class="info-value">{{ $perjanjian->pihak2_name }} ({{ $perjanjian->pihak2_jabatan }})</div>
            </div>
            <div class="info-row">
                <div class="info-label">Periode:</div>
                <div class="info-value">{{ $perjanjian->periode ?? '-' }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Tanggal Dibuat:</div>
                <div class="info-value">{{ $perjanjian->created_at->format('d F Y') }}</div>
            </div>
            <div class="info-row">
            ...
            <div class="rejection-info">
                ...
                <p>{{ $perjanjian->rejection_reason }}</p>
            </div>
            @endif
        </div>
        ...
        <div class="pdf-container">
            <iframe src="{{ route('direktur.perjanjian.print', $perjanjian->id) }}" title="Preview Perjanjian"></iframe>
        </div>
    ...
    <script>
        ...
        const perjanjianId = {{ $perjanjian->id }};
        ...
        function printPDF() {
            ...
            link.href = '{{ route('direktur.perjanjian.download', $perjanjian->id) }}';
            link.download = 'Perjanjian_Kinerja_{{ str_replace(' ', '_', $perjanjian->pihak1_name) }}.pdf';
        ...
        function showRejectionNotification() {
            alert('Alasan Penolakan:\n\n' + @json($perjanjian->rejection_reason ?? ''));
        }
