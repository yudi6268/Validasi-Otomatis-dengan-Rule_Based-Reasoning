...
<body>
        ...
        <div class="header-top">
            ...
            <div class="icons">
                ...
                <div id="profileMenu" class="profile-menu">
                    ...
                    <a href="{{ route('kontak') }}"><i class="fa-solid fa-phone"></i>Kontak</a>
                    <a href="{{ route('tentang') }}"><i class="fa-solid fa-info-circle"></i>Tentang</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <script>
        ...
        function loadData(filter = 'all') {
            fetch(`{{ route('direktur.perjanjian') }}?filter=${filter}`, {
                headers: {
