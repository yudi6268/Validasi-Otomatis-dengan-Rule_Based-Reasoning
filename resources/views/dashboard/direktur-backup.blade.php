...
<header>
  <div class="logo-container">
    <img src="{{ asset('images/logo_pemda.png') }}">
...
<div id="profileModal" style="display:none;position:absolute;top:62px;right:48px;background:#E6FAF7;border-left:6px solid #FFB6B6;z-index:99999;box-shadow:0 2px 16px rgba(0,0,0,0.08);border-radius:14px;padding:18px 0 8px 0;min-width:210px;max-width:260px;">
  <div style="display:flex;flex-direction:column;gap:16px;align-items:flex-start;padding-left:20px;padding-right:20px;">
    <a href="{{ route('profil') }}" style="display:flex;align-items:center;gap:12px;color:#0DA45C;font-size:16px;font-weight:600;text-decoration:none;margin-bottom:4px;"><i class="fa-solid fa-user" style="font-size:22px;"></i> Profil Saya</a>
    <a href="{{ route('kontak') }}" style="display:flex;align-items:center;gap:12px;color:#0DA45C;font-size:16px;font-weight:600;text-decoration:none;margin-bottom:4px;"><i class="fa-solid fa-phone" style="font-size:22px;"></i> Kontak</a>
    <a href="{{ route('panduan') }}" style="display:flex;align-items:center;gap:12px;color:#0DA45C;font-size:16px;font-weight:600;text-decoration:none;margin-bottom:4px;"><i class="fa-solid fa-book" style="font-size:22px;"></i> Panduan</a>
    <a href="{{ route('tentang') }}" style="display:flex;align-items:center;gap:12px;color:#0DA45C;font-size:16px;font-weight:600;text-decoration:none;margin-bottom:4px;"><i class="fa-solid fa-circle-info" style="font-size:22px;"></i> Tentang Aplikasi</a>
    <a href="{{ route('settings') }}" style="display:flex;align-items:center;gap:12px;color:#0DA45C;font-size:16px;font-weight:600;text-decoration:none;margin-bottom:4px;"><i class="fa-solid fa-gear" style="font-size:22px;"></i> Settings</a>
  </div>
...
<div class="container">
  ...
  <div class="box">
    ...
    <table>
      ...
      <tbody id="dataTable">
        @foreach($perjanjians as $i => $perjanjian)
        <tr>
          ...
          <td style="text-align:center; vertical-align:middle;">
            <a href="{{ route('perjanjian.print', $perjanjian->id) }}" class="btn" target="_blank">Lihat</a>
          </td>
        </tr>
        @endforeach
      </tbody>
    </table>
    @if(method_exists($perjanjians, 'hasPages') && $perjanjians->hasPages())
...
async function refreshDashboardData() {
  try {
    const res = await fetch('{{ route('direktur.perjanjian') }}', {
      method: 'GET',
      cache: 'no-store',
