        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.kegiatan.store', $program['id']) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_kegiatan" id="kode_kegiatan" class="form-control @error('kode_kegiatan') is-invalid @enderror" placeholder="Contoh: KGT001" required value="{{ old('kode_kegiatan') }}">
                    @error('kode_kegiatan')
