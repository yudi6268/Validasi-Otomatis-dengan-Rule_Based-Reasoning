...
@section('back')
<a href="{{ $backRoute }}" id="headerBackBtn"><i class="fa-solid fa-arrow-left header-icon"></i></a>
@endsection
    ...
    <div class="card-list">
        @forelse($items as $item)
            ...
            <div class="perjanjian-card" onclick="window.open('{{ $pdfViewUrl }}','_blank')">
                ...
                <div class="card-content">
                    <div class="card-title">Laporan Kinerja {{ $item['tahun'] ?? date('Y') }}</div>
                    <div class="card-employee">{{ $item['employee_name'] }}</div>
                    ...
                    <div class="card-date">{{ $triwulanText }}</div>
                </div>
                <div class="card-actions" onclick="event.stopPropagation()">
                    {{-- View (PDF) --}}
                    <a href="{{ $pdfViewUrl }}" target="_blank" class="action-btn btn-view" title="Lihat PDF">
        ...
        @empty
            <div class="empty-state">
                ...
                <p>Tidak ada laporan kinerja{{ $statusFilter ? ' dengan status ini' : '' }}.</p>
            </div>
        @endforelse
    </div>
</div>
